...
import { Mail, UserCheck, DatabaseZap } from "lucide-react";
...
const ACTION_ICONS: Record<string, React.ElementType> = {
  ...
  [BpmnNodeType.HumanReview]: UserCheck,
  [BpmnNodeType.UpdateDB]: DatabaseZap,
};

function ActionNodeComponent({ data, selected }: NodeProps<BpmnNode>) {
  const Icon = ACTION_ICONS[data.bpmnType] ?? Mail;
  ...
  return (
    ...
    >
      ...
      />
      <div className="h-2 rounded-t-lg bg-teal-500" />
